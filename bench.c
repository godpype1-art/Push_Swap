...
static void	print_ops(t_pushswap *bench, int fd)
{
	...
	ft_putstr_fd(ft_itoa(bench->total_ops), fd);
	ft_putstr_fd("\n[bench] sa: ", fd);
	ft_putstr_fd(ft_itoa(bench->sa), fd);
	ft_putstr_fd(" sb: ", fd);
	ft_putstr_fd(ft_itoa(bench->sb), fd);
	ft_putstr_fd(" ss: ", fd);
	ft_putstr_fd(ft_itoa(bench->ss), fd);
	ft_putstr_fd(" pa: ", fd);
	ft_putstr_fd(ft_itoa(bench->pa), fd);
	ft_putstr_fd(" pb: ", fd);
	ft_putstr_fd(ft_itoa(bench->pb), fd);
	ft_putstr_fd("\n[bench] ra: ", fd);
	ft_putstr_fd(ft_itoa(bench->ra), fd);
	ft_putstr_fd(" rb: ", fd);
	ft_putstr_fd(ft_itoa(bench->rb), fd);
	ft_putstr_fd(" rr: ", fd);
	ft_putstr_fd(ft_itoa(bench->rr), fd);
	ft_putstr_fd(" rra: ", fd);
	ft_putstr_fd(ft_itoa(bench->rra), fd);
	ft_putstr_fd(" rrb: ", fd);
	ft_putstr_fd(ft_itoa(bench->rrb), fd);
	ft_putstr_fd(" rrr: ", fd);
	ft_putstr_fd(ft_itoa(bench->rrr), fd);
	ft_putchar_fd('\n', fd);
}
...
void	print_bench(t_pushswap *bench)
{
	...
	ft_putstr_fd(ft_itoa(whole), fd);
	ft_putchar_fd('.', fd);
	ft_putstr_fd(ft_itoa(decimal), fd);
	ft_putstr_fd("%\n[bench] strategy: ", fd);
